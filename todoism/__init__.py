...
from todoism.apis.v1 import api_v1 # 将api_v1蓝本注册到程序实例上
...
def register_extensions(app):
    ...
    csrf.init_app(app)
    csrf.exempt(api_v1) # 取消对api_v1蓝本的CSRF保护
    babel.init_app(app)
...
def register_blueprints(app):
    ...
    # 将api_v1蓝本注册到程序实例上
    app.register_blueprint(api_v1, url_prefix='/api/v1') # 方式1：设置前缀  http://demo.com/api/v1
    # app.register_blueprint(api_v1, url_prefix='/v1', subdomain='api')  # enable subdomain support # 方式2：就是设置子域
